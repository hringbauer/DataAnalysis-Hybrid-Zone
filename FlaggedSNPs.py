...
class FlaggedSNPs(object):
    ...
    def set_colors(self):
        ...
        color = np.array(['grey' for _ in range(0, len(self.color))]).astype('|S16')
        color[self.color == 'Y'] = 'y'
        color[self.color == 'FR'] = 'm'
        color[self.color == 'W'] = 'azure'
        color[self.color == 'FO'] = 'darkorange'
        color[self.color == 'WO'] = "sandybrown"
        color[self.color == 'WR'] = "lightsalmon"
        self.color = color
